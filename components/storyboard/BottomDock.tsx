...
function CharacterCard({
  ...
  return (
    <div className="flex w-[190px] shrink-0 gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900/50 p-1.5">
      {/* 基準画像 */}
      <div className="flex w-[56px] shrink-0 flex-col gap-1">
        <div className="flex h-[74px] w-[56px] items-center justify-center overflow-hidden rounded border border-zinc-700 bg-zinc-800">
          {c.thumbUrl ? (
        ...
        <div className="flex gap-0.5">
          <Button
            className="flex-1 px-0 py-0.5 text-[9px]"
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        <div className="flex items-center gap-1">
          <input
            ...
            placeholder="名前"
            className="min-w-0 flex-1 rounded border border-zinc-700 bg-zinc-800 px-1 py-0.5 text-[11px] font-semibold"
        ...
        <input
          ...
          className="rounded border border-zinc-800 bg-zinc-900 px-1 py-0.5 font-mono text-[9px] text-amber-300/80"
        ...
        <textarea
          ...
          rows={3}
          className="min-h-0 flex-1 resize-none rounded border border-zinc-700 bg-zinc-800 px-1 py-1 text-[10px] leading-snug"
        ...
        <div className="grid grid-cols-3 content-start gap-x-2 gap-y-1 p-2">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full resize-none rounded border border-zinc-700 bg-zinc-800 px-2 py-1 text-[10px]"
            />
          </div>
